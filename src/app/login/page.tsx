    ...
    <div className="min-h-screen bg-[#faf8f5] flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#0f1729] mb-2">Welcome back</h1>
          <p className="text-[#4a5568]">Log in to your account to continue</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 text-[#4ECDC4] border-[#d1d5db] rounded focus:ring-[#4ECDC4]"
              />
              <label htmlFor="rememberMe" className="ml-2 text-sm text-[#4a5568]">
                Remember me
              </label>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#4a5568]">
              ...
              <Link href="/register" className="text-[#4ECDC4] font-semibold hover:underline">
                Create one now
              </Link>
            </p>
          </div>
